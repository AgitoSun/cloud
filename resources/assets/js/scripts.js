...
!function (p, x) {
    ...
    var r = x(window), a = x("body"), c = x(document), e = "nk-menu", s = "nk-header-menu", l = "nk-sidebar",
        t = "nk-sidebar-mobile", d = p.Break;
    ...
    p.ClassBody = function () {
        p.AddInBody(l), p.AddInBody("nk-apps-sidebar")
    }, p.ClassNavMenu = function () {
        p.BreakClass("." + s, d.lg, {timeOut: 0}), p.BreakClass("." + l, d.lg, {
            timeOut: 0,
            classAdd: t
        }), r.on("resize", function () {
            p.BreakClass("." + s, d.lg), p.BreakClass("." + l, d.lg, {classAdd: t})
        })
    }, p.Prettify = function () {
        window.prettyPrint && prettyPrint()
    }, p.Copied = function () {
        var e = ".clipboard-init", i = ".clipboard-text", o = "clipboard-success", s = "clipboard-error";

        function t(e, t) {
            var e = x(e), n = e.parent(), a = {text: "Copy", done: "Copied", fail: "Failed"},
            ...
            n.addClass("success" === t ? o : s).find(i).html(e), setTimeout(function () {
        ...
        x(".nk-menu-link, .menu-link, .nav-link").each(function () {
            var e = x(this), t = e.attr("href");
            n.match(t) ? (e.closest("li").addClass("active current-page").parents().closest("li").addClass("active current-page"), e.closest("li").children(".nk-menu-sub").css("display", "block"), e.parents().closest("li").children(".nk-menu-sub").css("display", "block"), this.scrollIntoView({block: "start"})) : e.closest("li").removeClass("active current-page").parents().closest("li:not(.current-page)").removeClass("active")
        })
        ...
        var a = "info" === (t = t || "info") ? "ni ni-info-fill" : "success" === t ? "ni ni-check-circle-fill" : "error" === t ? "ni ni-cross-circle-fill" : "warning" === t ? "ni ni-alert-fill" : "",
            i = {position: "bottom-right", ui: "", icon: "auto", clear: !1}, n = n ? u(i, n) : i;
        n.position = n.position ? "toast-" + n.position : "toast-bottom-right", n.icon = "auto" === n.icon ? a : n.icon || "", n.ui = n.ui ? " " + n.ui : "", i = "" !== n.icon ? '<span class="toastr-icon"><em class="icon ' + n.icon + '"></em></span>' : "", "" !== (e = "" !== e ? i + '<div class="toastr-text">' + e + "</div>" : "") && (!0 === n.clear && toastr.clear(), a = {
            closeButton: !0,
            debug: !1,
            newestOnTop: !1,
            progressBar: !1,
        ...
        var e = x(e || ".toggle"), n = x("[data-content]"), o = !1,
            a = {active: "active", content: "content-active", break: !0}, s = t ? u(a, t) : a;
        p.TGL.screen(n), e.on("click", function (e) {
            o = this, p.Toggle.trigger(x(this).data("target"), s), e.preventDefault()
        }), c.on("mouseup", function (e) {
            var t, n, a, i;
            o && (t = x(o), n = x(o).data("target"), n = x('[data-content="'.concat(n, '"]')), a = x(".datepicker-dropdown"), i = x(".ui-timepicker-container"), t.is(e.target) || 0 !== t.has(e.target).length || n.is(e.target) || 0 !== n.has(e.target).length || 0 !== x(e.target).closest(".select2-container").length || a.is(e.target) || 0 !== a.has(e.target).length || i.is(e.target) || 0 !== i.has(e.target).length || (p.Toggle.removed(t.data("target"), s), o = !1))
        }), r.on("resize", function () {
            n.each(function () {
                var e = x(this).data("content"), t = x(this).data("toggle-screen"), t = d[t];
                p.Win.width > t && p.Toggle.removed(e, s)
            })
        })
    }, p.TGL.expand = function (e, t) {
        var e = e || ".expand", n = {toggle: !0}, a = t ? u(n, t) : n;
        x(e).on("click", function (e) {
            p.Toggle.trigger(x(this).data("target"), a), e.preventDefault()
        })
    }, p.TGL.ddmenu = function (e, t) {
        var e = e || ".nk-menu-toggle", n = {active: "active", self: "nk-menu-toggle", child: "nk-menu-sub"},
            a = t ? u(n, t) : n;
        x(e).on("click", function (e) {
            (p.Win.width < d.lg || x(this).parents().hasClass(l)) && p.Toggle.dropMenu(x(this), a), e.preventDefault()
        })
    }, p.TGL.showmenu = function (e, t) {
        var n = x(e || ".nk-nav-toggle"), a = x("[data-content]"), i = a.hasClass(s) ? d.lg : d.xl, e = {
        ...
        var n = {active: "active", timeout: 400, target: "[data-search]"}, a = t ? u(n, t) : n, i = x(e),
            o = x(a.target);
        i.exists() && (i.on("click", function (e) {
            e.preventDefault();
            var e = x(this).data("target"), t = x("[data-search=" + e + "]"), e = x("[data-target=" + e + "]");
        ...
        var n = {focus: "focused"}, a = t ? u(n, t) : n;
        x(e).exists() && x(e).each(function () {
            var e = x(this);
        ...
        x(e).exists() && (x(e).each(function () {
            var e = {errorElement: "span"}, e = t ? u(e, t) : e;
            x(this).validate(e)
        }), p.Validate.OnChange(".js-select2"), p.Validate.OnChange(".date-picker"), p.Validate.OnChange(".js-tagify"))
        ...
        p.Validate(".form-validate", {
            errorElement: "span", errorClass: "invalid", errorPlacement: function (e, t) {
        ...
        x(a).exists() && x(a).each(function () {
            var e = x(a).data("max-files") || null, t = x(a).data("max-file-size") || 256,
                n = x(a).data("accepted-files"),
                e = {autoDiscover: !1, maxFiles: e, maxFilesize: t, acceptedFiles: n || null}, t = i ? u(e, i) : e;
        ...
        e.exists() && e.each(function () {
            var e = x(this).attr("id"), a = x("#" + e).show();
            a.steps({
        ...
        x(e).exists() && x(e).each(function () {
            var e = x(this).data("auto-responsive"), t = !(void 0 === o.buttons || !o.buttons),
                ...
                }, t = o ? u(a, o) : a, t = !1 === e ? u(t, {responsive: !1}) : t;
            x(this).DataTable(t), x(".dt-export-title").text(n)
        })
    }, p.DataTable.init = function () {
        p.DataTable(".datatable-init", {responsive: {details: !0}}), p.DataTable(".datatable-init-export", {
        ...
        x(e || ".dropdown-menu").on("click", function (e) {
            ...
            var e = x(this);
            e.hasClass("dropdown-menu-end") && !e.hasClass("dropdown-menu-center") ? e.prev('[data-bs-toggle="dropdown"]').dropdown({popperConfig: {placement: "bottom-start"}}) : e.hasClass("dropdown-menu-end") || e.hasClass("dropdown-menu-center") || e.prev('[data-bs-toggle="dropdown"]').dropdown({popperConfig: {placement: "bottom-end"}})
        })
    }, p.BS.tabfix = function (e) {
        x(e || '[data-bs-toggle="modal"]').on("click", function () {
            var e = x(this), t = e.data("target"), n = e.attr("href"), e = e.data("tab-target"),
        ...
        var n, a;
        x(e).exists() && "function" == typeof x.fn.knob && (n = {min: 0}, a = t ? u(n, t) : n, x(e).each(function () {
            x(this).knob(a)
        }))
    }, p.Knob.init = function () {
        var e = {readOnly: !0, lineCap: "round"}, t = {angleOffset: -90, angleArc: 180, readOnly: !0, lineCap: "round"};
        p.Knob(".knob", e), p.Knob(".knob-half", t)
    }, p.Range = function (e, d) {
        x(e).exists() && "undefined" != typeof noUiSlider && x(e).each(function () {
            var e = x(this), t = e.attr("id"), n = e.data("start"), n = (n = /\s/g.test(n) ? n.split(" ") : n) || 0,
                a = e.data("connect"), a = void 0 === (a = /\s/g.test(a) ? a.split(" ") : a) ? "lower" : a,
                i = e.data("min") || 0, o = e.data("max") || 100, s = e.data("min-distance") || null,
                r = e.data("max-distance") || null, c = e.data("step") || 1, l = e.data("orientation") || "horizontal",
                e = e.data("tooltip") || !1, t = (console.log(e), document.getElementById(t)), n = {
                    start: n,
                    connect: a,
        ...
        x(e).exists() && x(e).each(function () {
            ...
            } : {type: "image", mainClass: "mfp-fade image-popup"}, e = n ? u(e, n) : e;
        ...
        a.forEach(function (e, t, n) {
            ...
            a[t].addEventListener("click", function () {
                ...
                s.forEach(function (e, t, n) {
                    var a, i, o;
                    s[t].classList.contains("number-spinner") && (a = "" == !s[t].value ? parseInt(s[t].value) : 0, i = "" == !s[t].step ? parseInt(s[t].step) : 1, o = "" == !s[t].max ? parseInt(s[t].max) : 1 / 0, s[t].value = a + i < o + 1 ? a + i : a)
                })
            })
            ...
            i[t].addEventListener("click", function () {
                ...
                s.forEach(function (e, t, n) {
                    var a, i, o;
                    s[t].classList.contains("number-spinner") && (a = "" == !s[t].value ? parseInt(s[t].value) : 0, i = "" == !s[t].step ? parseInt(s[t].step) : 1, o = "" == !s[t].min ? parseInt(s[t].min) : 0, s[t].value = o - 1 < a - i ? a - i : a)
                })
            })
        })
    }, p.Custom.Stepper = function (n, e) {
        var t = !(!n.dataset.stepInit || isNaN(n.dataset.stepInit)) && parseInt(n.dataset.stepInit), t = {
                selectors: {
            ...
            r = n.querySelector(".".concat(t.selectors.prev)), c = n.querySelector(".".concat(t.selectors.next)),
            l = n.querySelector(".".concat(t.selectors.submit)), d = t.classes.nav_current, p = t.classes.nav_done,
            u = t.classes.step_active, f = t.classes.step_done, e = t.current_step || 1, g = e, m = a.length,
            h = i.length, v = 0 < n.querySelectorAll(".".concat(t.selectors.nav)).length,
            b = 0 < n.querySelectorAll(".".concat(t.selectors.progress)).length;

        function k(e) {
            var t = e - 1, t = (n.style.display = "block", v && (a.forEach(function (e, t) {
                e.classList.remove(d)
            }), a[t].classList.add(d)), i.forEach(function (e, t) {
                e.classList.remove(u)
            }), i[t].classList.add(u), e);
            1 === t && (c.style.display = "block", r.style.display = "none", l.style.display = "none", n.setAttribute("data-step-current", "first")), h !== t & 1 !== t && (r.style.display = "block", c.style.display = "block", l.style.display = "none", n.setAttribute("data-step-current", t)), h === t && (r.style.display = "block", l.style.display = "block", c.style.display = "none", n.setAttribute("data-step-current", "last")), b && (o.innerHTML = "".concat(e, " of ").concat(h), s.style.width = "".concat(100 / h * e, "%"))
        }
        ...
        p.BS.menutip("a.nk-menu-link"), p.BS.tooltip(".nk-tooltip"), p.BS.tooltip(".btn-tooltip", {placement: "top"}), p.BS.tooltip('[data-toggle="tooltip"]'), p.BS.tooltip('[data-bs-toggle="tooltip"]'), p.BS.tooltip(".tipinfo,.nk-menu-tooltip", {placement: "right"}), p.BS.popover('[data-toggle="popover"]'), p.BS.popover('[data-bs-toggle="popover"]'), p.BS.progress("[data-progress]"), p.BS.fileinput(".form-file-input"), p.BS.modalfix(), p.BS.ddfix(), p.BS.tabfix()
        ...
        p.TGL.content(".toggle"), p.TGL.expand(".toggle-expand"), p.TGL.expand(".toggle-opt", {toggle: !1}), p.TGL.showmenu(".nk-nav-toggle"), p.TGL.ddmenu("." + e + "-toggle", {
            self: e + "-toggle",
            child: e + "-sub"
        })
